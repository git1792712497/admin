  ...
  <el-card shadow="hover" style="height: 100%" :body-style="{ height: '100%' }">
    <template #header>
      <nav class="flex justify-between">
        ...
        <el-link type="primary" target="_blank" href="https://headlessui.com/">文档</el-link>
      </nav>
    </template>

    <div class="fixed inset-0 flex items-center justify-center">
      <button type="button" @click="openModal" class="rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">Open dialog</button>
    </div>
...
<script setup lang="ts" name="headlessui">
import { ref } from 'vue'
