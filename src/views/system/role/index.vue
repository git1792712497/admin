<template>
  <el-card>
    <template #header><TopSearch @addRole="AddRoleDialogRef.openDialog({})"/></template>
    ...
    <el-table v-loading="loading" size="large" border :data="data?.data" row-key="id">
      ...
      <el-table-column fixed="right" label="操作" width="200" align="center">
        <template #default="{row}">
          <el-button link type="primary" size="small" @click="AddRoleDialogRef.openDialog(row)">编辑 <el-icon><Edit /></el-icon></el-button>
