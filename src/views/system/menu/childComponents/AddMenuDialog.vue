<template>
  <el-dialog v-model="dialogVisible" title="新增菜单" :width="500">
    <el-form ref="formRef" :model="basicForm" status-icon :rules="rules" label-width="80px">
      ...
      <el-form-item v-if="basicForm.type !== 1" label="父级菜单" prop="parentId">
      ...
      <el-form-item v-if="basicForm.type !== 3" label="菜单路由" prop="path">
        <el-input v-model="basicForm.path" clearable placeholder="请输入路由path">
      ...
      <el-row :gutter="20">
       <el-col :span="12">
         <el-form-item label="菜单排序" prop="sort">
           <el-input-number v-model="basicForm.sort" :min="0" placeholder="菜单序号"/>
         </el-form-item>
       </el-col>
        <el-col :span="12">
...
const handleConfirm = () => {
  formRef.value.validate(async isValid => {
    ...
    menuForm.path += currentPath.value
    try {
